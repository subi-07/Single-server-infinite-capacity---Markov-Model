...
## Output :
```
Enter the mean inter arrival time of objects from Feeder (in secs): 1111
Enter the mean  inter service time of Lathe Machine (in secs) :  2222
Enter the Additional time taken for the Robot (in secs) :  3333
--------------------------------------------------------------
Single Server with Infinite Capacity - (M/M/1):(oo/FIFO)
--------------------------------------------------------------
The mean arrival rate per second : 0.00 
The mean service rate per second : 0.00 
